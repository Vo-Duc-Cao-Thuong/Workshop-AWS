...
| --------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- | --------------- | ----------------------------------------- |
| Monday    | - Create an **Amazon S3 Bucket** <br> - Create an **Amazon Kinesis Data Firehose Delivery Stream** <br> - Generate sample data and store it in Amazon S3                                                                                                                               | 13/07/2026 | 13/07/2026      | <https://cloudjourney.awsstudygroup.com/> |
| Tuesday   | - Practice using **AWS Glue Crawlers** <br> - Explore data with the **AWS Glue Data Catalog** <br> - Query data using **Amazon Athena** and visualize the results with **Amazon QuickSight**                                                                                           | 14/07/2026 | 14/07/2026      | <https://cloudjourney.awsstudygroup.com/> |
| Wednesday | - Learn about **Amazon DynamoDB** <br> - Practice creating tables, inserting data, and performing operations using the DynamoDB Console <br> - Explore common DynamoDB design patterns                                                                                                 | 15/07/2026 | 15/07/2026      | <https://cloudjourney.awsstudygroup.com/> |
| Thursday  | - Practice using **AWS CloudShell**, **AWS SDK**, and **AWS Cloud9** <br> - Use **AWS Glue DataBrew** to clean and transform data                                                                                                                                                      | 16/07/2026 | 16/07/2026      | <https://cloudjourney.awsstudygroup.com/> |
| Friday    | - Build a data pipeline using **AWS Glue** <br> - Analyze data with **Amazon Athena** and **Amazon Kinesis Data Analytics** <br> - Visualize data using **Amazon QuickSight** <br> - Explore serverless data processing with **AWS Lambda** and data storage using **Amazon Redshift** | 17/07/2026 | 17/07/2026      | <https://cloudjourney.awsstudygroup.com/> |
